...
class WorkerBottomNavBar extends StatelessWidget {
  ...
  static const _tabs = [
    _NavTab(label: 'Home', emoji: '🏠', route: '/worker/home'),
    _NavTab(label: 'My Jobs', emoji: '🔧', route: '/worker/jobs'),
    _NavTab(label: 'Chat', emoji: '💬', route: '/worker/chat'),
    _NavTab(label: 'Profile', emoji: '👤', route: '/worker/profile'),
  ];
