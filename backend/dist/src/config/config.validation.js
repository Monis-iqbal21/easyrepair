...
class EnvironmentVariables {
    constructor() {
        this.PORT = 3000;
        this.JWT_ACCESS_EXPIRES = '15m';
        this.JWT_REFRESH_EXPIRES = '30d';
        this.STORAGE_PROVIDER = StorageProvider.S3;
        this.PLATFORM_FEE_PERCENT = 10;
        this.USE_POSTGIS = 'false';
    }
}
__decorate([
...
__decorate([
    ...
    (0, class_validator_1.IsOptional)(),
    __metadata("design:type", String)
], EnvironmentVariables.prototype, "AWS_BUCKET", void 0);
__decorate([
    (0, class_validator_1.IsString)(),
    (0, class_validator_1.IsOptional)(),
    __metadata("design:type", String)
...
__decorate([
    ...
    (0, class_validator_1.IsOptional)(),
    __metadata("design:type", String)
], EnvironmentVariables.prototype, "AWS_SECRET_KEY", void 0);
__decorate([
    (0, class_validator_1.IsNumber)(),
    (0, class_validator_1.IsOptional)(),
    __metadata("design:type", Number)
], EnvironmentVariables.prototype, "PLATFORM_FEE_PERCENT", void 0);
__decorate([
    (0, class_validator_1.IsString)(),
    (0, class_validator_1.IsOptional)(),
    __metadata("design:type", String)
], EnvironmentVariables.prototype, "USE_POSTGIS", void 0);
